...
class AMapController extends ChangeNotifier {
  AMapController._(this._id, AMapOptions options, MethodChannel channel)
      : assert(_id != null),
        assert(options != null),
    ...
    _options = AMapOptions.defaultOptions.copyWith(options);
  }

  static Future<AMapController> init(int id, AMapOptions options) async {
    assert(id != null);
    assert(options != null);
    assert(options.cameraPosition != null);
  ...
  AMapOptions get options => _options;
  ...
  Future<void> updateMapOptions(AMapOptions changes) async {
    assert(changes != null);
